...
- `adhd-timer-app-mvp-task-breakdown.md`
- `newMission.md` (임시 작업 프롬프트)
- `assets/add_ui.png` (보조 UI 시안 이미지)

## 2026-02-28-core-doc-pruning
현재 active 개발 흐름에서 직접 참조되지 않는 회고/아키텍처 문서를 분리 보관했습니다.
