...
- FR 기준: FR-01~09, FR-11~12는 `완료`, FR-10은 P1 항목으로 `부분` 유지
- UC/게이트 기준: UC-07, Gate-3/7/8/9를 포함해 MVP 코어 게이트(1~11) 근거 동기화 완료
- 검증 근거: `npm run verify:mvp` PASS (`typecheck/lint/test:mvp/build/verify:gate`)
