...
- [x] ✅ `TSK-04` 일정 목록/완료토글/삭제 UI 구현 (mock)
- [x] ✅ `TSK-03` 일정 생성/수정 모달(UI + 검증) 구현 (mock)
- [x] ✅ `PRI-02` 중요도 배지 + 우선순위 입력 UI 구현
...
- [ ] ⏳ `TSK-05` 오늘/이번주 필터 + 정렬(마감임박/우선순위) 구현
- [ ] ⏳ `PRI-03` 중요도/우선순위 독립 수정 플로우 구현
- [ ] ⏳ `PRI-04` 중요도 기준 정렬/필터 옵션 추가
- [ ] ⏳ `TMR-06` 백그라운드 복귀 시 경과시간 보정 처리
- [ ] ⏳ `TMR-08` 타이머 이벤트 트래킹 연동
- [ ] ⏳ `CAL-06` 연동 설정 화면(연결상태/마지막 동기화/동기화 버튼) 구현 (mock)
- [ ] ⏳ `CAL-07` 동기화 결과(성공/실패/충돌) 로그 UI 구현 (mock)
...
선행조건: `TMR-01`, `TMR-03`
- [ ] ⏳ `TMR-06` FE: 백그라운드 복귀 시 경과시간 보정 처리
선행조건: `TMR-03`
- [ ] ⏳ `TMR-08` FE: 타이머 이벤트 트래킹 연동
선행조건: `TMR-03`
...
- [x] ✅ `TSK-04` FE: 일정 목록/완료토글/삭제 UI 구현
선행조건: 없음 (mock 데이터 허용)
- [x] ✅ `TSK-03` FE: 일정 생성/수정 모달(UI + 검증) 구현
선행조건: 없음 (mock 데이터 허용)
- [ ] ⏳ `TSK-05` FE: 오늘/이번주 필터 + 정렬(마감임박/우선순위) 구현
선행조건: `TSK-04`
...
- [x] ✅ `PRI-02` FE: 중요도 배지 + 우선순위 입력 UI 구현
선행조건: 없음 (mock 데이터 허용)
- [ ] ⏳ `PRI-03` FE: 중요도/우선순위 독립 수정 플로우 구현
선행조건: `PRI-02`
- [ ] ⏳ `PRI-04` FE: 중요도 기준 정렬/필터 옵션 추가
선행조건: `PRI-02`
...
- [ ] ⏳ `CAL-06` FE: 연동 설정 화면(연결상태/마지막 동기화/동기화 버튼) 구현
선행조건: 없음 (mock 상태 허용)
- [ ] ⏳ `CAL-07` FE: 동기화 결과(성공/실패/충돌) 로그 UI 구현
선행조건: `CAL-06`
...
- [ ] ⏳ `FN-TSK-05` `toggleTaskCompletion(taskId, done)`
...
- [ ] ⏳ Week 2 (사용감): `TSK-05`, `PRI-03`, `PRI-04`, `TMR-06`, `TMR-08`, `CAL-06`, `CAL-07`
